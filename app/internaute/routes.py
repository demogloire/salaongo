...
#from app.promotion.forms import AjoutPromotionForm
...
def index():
   ...
   listes=Internaute.query.all()
   
   return render_template('internaute/index.html', title=title, liste=listes)
...
# @internaute.route('/ajouter', methods=['GET','POST'])
# @login_required
# def ajouter():
